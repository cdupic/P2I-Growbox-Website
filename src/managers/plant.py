...
def plant_manager():
    ...
    #       the code should update the plants in the GreenHousePlants table and switch is_custom_config to false.
        ...
        print(request.form.get('add-plant'))
        print()
        print(request.form.get('add-plant-count'))
        print()
        print(request.form.get('remove-associations'))
        print()
        print(request.form.get('remove-associations-count'))
